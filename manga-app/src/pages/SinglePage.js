...
const SinglePage = ({ loggedIn, favList, setFavList }) => {
   ...
   const { data, loading, error } = useQuery(
      type === 'ANIME' ? GET_SINGLE_ANIME : GET_SINGLE_MANGA,
      {
         variables: {
            id,
         },
         ...
         <div className="container">
            ...
            <div className="row">
               <div className="col-md-6">
                  <img
                     src={imgString}
                     alt={imgString.substring(imgString.lastIndexOf('/') + 1)}
                     className="my-2 anime-img"
                  />
               </div>
               <div className="col-md-6">
                  <p>
                  ...
                  <p>
                     ...
                     {Media.startDate.month}/{Media.startDate.year} -{' '}
                     {Media.endDate.month}/{Media.endDate.year}
                  </p>
                  <p>
            ...
            <div className="row">
               {Media.streamingEpisodes.length !== 0 ? (
                  Media.streamingEpisodes.map((value, key) => (
                     <div className="col-md-3" key={key}>
                        <p>{value.title}</p>
                        <a href={value.url} className="mx-1">
                           <img
                              src={value.thumbnail}
                              alt=""
                              style={{
      ...
      <div className="container">
         ...
         <div className="row">
            ...
            <div className="col-md-6">
               ...
               <p>
                  <strong># of Volumes: </strong>
                  {Media.volumes}
               </p>
               <p>
                  <strong># of Chapters: </strong>
                  {Media.chapters}
               </p>
               {buttonToggle()}
            </div>
